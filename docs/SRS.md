...
### 5.1 Class Diagram — `docs/uml/01_class_diagram.puml`
...
### 5.2 Sequence Diagram — `docs/uml/02_sequence_diagram.puml`
...
### 5.3 Use Case Diagram — `docs/uml/03_use_case_diagram.puml`
...
### 5.4 Component Diagram — `docs/uml/04_component_diagram.puml`
